  ...
  return (
    ...
    <Header />
      ...
      <main className="main-content">
        {activePage === "home" && (
          <HomePage
            currentUser={userData}          // 🟢 Ngombwa kugirango notifications na chat bikore
        ...
        {activePage === "chat" && targetUser && (
          <ChatWindow
            currentUser={userData}          // 🟢 Ngombwa kugirango chat ikore
            targetUser={targetUser}
            setActivePage={setActivePage}   // 🟢 Optional: back button muri ChatWindow
          />
        )}

        {activePage === "status" && <StatusPage currentUser={userData} />}
